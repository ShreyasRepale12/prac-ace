  ...
  <nav class="w-full lg:px-40 px-5 py-3 bg-transparent top-0 fixed z-10" style="background: rgba(0,32,33,1.0); ">
    <div class="flex items-center justify-between ">
      ...
      <div class="md:hidden">
        <button @click="drawer">
          <svg 
            class="h-8 w-8 fill-current rounded-md hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" style="color: #4ce6a7;"
      ...
      <div class="hidden md:block">
        <ul class="flex space-x-8 text-xl font-sans">
          <li><a href="#" class="text-white hover:text-gray-300 hover:bg-gray-700 hover:text-green-300 block px-2 py-2 rounded-md text-base font-medium">Home</a></li>
          <li><a href="#" class="text-white hover:text-gray-300 hover:bg-gray-700 hover:text-green-300 block px-2 py-2 rounded-md text-base font-medium">About</a></li>
      ...
      <!-- Drawer Menu -->
      <aside class="p-5 transform top-0 left-0 w-64 fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30" style="background-color: #09262d" :class="isOpen ? 'translate-x-0' : '-translate-x-full'">
        
        <div class="close">
          <button class="absolute top-0 right-0 mt-4 mr-4 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" style="color: #4ce6a7;" @click=" isOpen = false">
            <svg 
              class="w-6 h-6"
              fill="none" stroke-linecap="round" 
              stroke-linejoin="round" stroke-width="2"
        ...
        <div class="follow">
          <p class="italic font-sans text-sm" style="color: #4ce6a7;">follow us on:</p>
...
background: linear-gradient(90deg, rgba(131,58,180,1) 0%, rgba(253,29,29,1) 25%, rgba(252,176,69,1) 50%, rgba(69,252,133,1) 75%, rgba(71,69,252,1) 100%); height:4px;"></div> -->
  </div>
</template>
